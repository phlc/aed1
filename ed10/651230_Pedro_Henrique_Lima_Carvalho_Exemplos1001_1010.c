...
@return referencia para arranjo com inteiros
@param lines - quantidade de datos
@param columns - quantidade de datos
*/
...
int main ()
{
    ...
    do
    {
        //identidicar
        printf ("\n");
        IO_id ("ED10 - Exemplos 1001 - 1010");

        //opcoes
        IO_println ("Opcoes:");
        IO_println ("0- Sair");
        IO_println ("1- Mostra arranjo");
        IO_println ("2- Le arranjo do teclado");
        IO_println ("3- Le e grava arranjo em arquivo");
        IO_println ("4- Le arranjo de arquivo");
        IO_println ("5- Copia Arranjo");
        IO_println ("6- Mostra matriz");
        IO_println ("7- Le matriz do teclado");
        IO_println ("8- Le e grava matriz em arquivo");
        IO_println ("9- Le matriz de arquivo");
        IO_println ("10- Copia matriz");
