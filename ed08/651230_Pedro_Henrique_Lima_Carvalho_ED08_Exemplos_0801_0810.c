...
int main ()
{
    ...
    do
    {
        //identidicar
        printf ("\n");
        IO_id ("ED08 - Exemplos 0801 - 0810");

        //opcoes
        IO_println ("Opcoes:");
        IO_println ("0- Sair");
        IO_println ("1- Mostrar inteiros de arranjo");
        IO_println ("2- Le do teclado inteiros de arranjo");
        IO_println ("3- Le e grava em arquivo inteiros de arranjo");
        IO_println ("4- Le inteiros de arranjo em arquivo e mostra");
        IO_println ("5- Copia inteiros de um arranjo para outro");
        IO_println ("6- Soma inteiros de um arranjos");
        IO_println ("7- Verifica se todos valores de arranjo sao zero");
        IO_println ("8- Soma dois arranjos de inteiros por posicao");
        IO_println ("9- Verifica se arranjos sao iguais");
        IO_println ("10- Procura certo inteiro em um arranjo");
