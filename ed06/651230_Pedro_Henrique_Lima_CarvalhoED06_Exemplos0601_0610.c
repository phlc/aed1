...
void method01 ( )
{
   ...
   // identificar
   IO_id ( "EXEMPLO0601 - 0610 - Method01 - v0.0" );
...
{
   // identificar
   IO_id ( "EXEMPLO0601 - 0610 - Method02 - v0.0" );
...
{
   // identificar
   IO_id ( "EXEMPLO0601 - 0610 - Method03 - v0.0" );
...
{
   // identificar
   IO_id ( "EXEMPLO0601 - 0610 - Method04 - v0.0" );
...
{
   // identificar
   IO_id ( "EXEMPLO0601 - 0610 - Method05 - v0.0" );
...
void method06 ( )
{
   ...
   // identificar
   IO_id ( "EXEMPLO0601 - 0610 - Method06 - v0.0" );
...
void method07 ( )
{
   ...
   // identificar
   IO_id ( "EXEMPLO0601 - 0610 - Method07 - v0.0" );
...
{
   // identificar
   IO_id ( "EXEMPLO0601 - 0610 - Method08 - v0.0" );
...
{
   // identificar
   IO_id ( "EXEMPLO0601 - 0610 - Method09 - v0.0" );
...
{
   // identificar
   IO_id ( "EXEMPLO0601 - 0610 - Method10 - v0.0" );
...
/**
Funcao Principal - Apresenta uma lista de metodos a serem escolhidos
*/
...
int main ()
{
   ...
   //identificar
   IO_id ( "EXEMPLO0601 - 0610 - Programa - v0.0" );
   
   //repetir ate break
   do
   {
      //mostrar opcoes
      IO_println ("Escolha uma das opcoes:");
      ...
      IO_println ("9- Gerardor de numeros fibonacci");
      IO_println ("10- Contador de letras minusculas");
      
      //ler teclado
      x = IO_readint ("Digite sua opcao: ");
