...
/**
Funcao para contar todos simbolos alfanumericos (letras e digitos)
 e espaços em brancoem varias cadeias de caracteres
return int - numero de simbolos alfanumericos
parametros string e ponteiro de int para conta total
*/

int totalb_alfanum (chars string, int* total)
{
   //define dados
   int tamanho = 0;
   int contador = 0;
...
/**
Funcao para contar quantos digitos tem uma cadeia de caracteres
return int numero de digitos
parametro uma string 
*/

int qnts_digitos (char *string)
{
   //define dados
   int digitos = 0;
   int tamanho = 0;
   ...
   //testar cada caractere da string
   for (int x = 0; x < tamanho; x =  x + 1)
   {
      //testar se e' digito
      if (('0' <= string [x]) && (string [x] <= '9'))
...
void method11 ( )
{
   ...
   for (int x = 0; x < quantidade; x = x + 1)
   {
      ...
      //corrigir gets pegando lixo
      getchar();
      
      //ler cadeia do teclado incluindo espaco em branco
      gets (cadeias [x]);
   }//fim for
   ...
   {
      //contar simbolos alfanumericos em cada cadeia
      cada = totalb_alfanum (cadeias[x], &total);
...
{
   //define dados
   chars sequencia1 = IO_new_chars (STR_SIZE);
   chars sequencia2 = IO_new_chars (STR_SIZE);
   int digitos1 = 0;
   int digitos2 = 0;
   ...
   //ler teclado
   sequencia1 = IO_readstring ("Entrar com 1a sequencia  de caracteres: ");
   sequencia2 = IO_readstring ("Entrar com 2a sequencia  de caracteres: ");
   
   //contar simbolos alfanumericos
   digitos1 = qnts_digitos (sequencia1);
   digitos2 = qnts_digitos (sequencia2);
   
   //comparar quantidade de digitos
   if (digitos1 < digitos2)
   {
      printf ("%s%d\n%s%d\n%s\n", "N. digitos da 1a sequencia: ", 
               digitos1, "N. digitos da 2a sequencia: ", digitos2,
               "2a sequencia tem mais digitos");
   ...
   if (digitos1 == digitos2)
   {
      printf ("%s%d\n%s%d\n%s\n", "N. digitos da 1a sequencia: ", 
               digitos1, "N. digitos da 2a sequencia: ", digitos2,
               "Sequencias tem mesmo numero de digitos");
...
int main ( )
{
   ...
   do
   {
      ...
      IO_println ( "11 - ler quantidade de caracteres, contar simbolos alfanumericos, calcular total de simbolos + espaco em branco por funcao" );
      IO_println ( "12 - ler duas cadeias de caracteres e calcular quais das duas tem menos digitos" );
      IO_println ( "" );
