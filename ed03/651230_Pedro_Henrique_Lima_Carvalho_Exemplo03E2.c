...
/**
Method12 -  Dizer se a sequencia contem apenas simbolos que nao sao letras.
*/
void method12 ( )
{
   // definir dado
   ...
   // passar por cada caracter
   for (int x = 0; x < tamanho; x = x + 1)
   {
      // verificar se tem letra maiuscula ou minuscula
      if (((65 <= (int) cadeia [x]) && ((int) cadeia [x] <= 90)) || ((97 <= (int) cadeia [x]) && ((int) cadeia [x] <= 122)))
      {
         // alterar valor de contador se houver letras
         contador = contador + 1; 
      }
      // passar ao proximo valor
   } // fim repetir
   
   // informar se ha letras
   if (contador == 0)
   {
      printf ("%s\n", "Cadeia tem apenas simbolos.");
   }
   else
   {
      printf ("%s\n", "Cadeia contem letras.");
   }
...
int main ( )
   ...
   do
   {
      ...
      IO_println ( "12 - teste se cadeia contem apenas simbolos que nao letras." );
      IO_println ( "" );
